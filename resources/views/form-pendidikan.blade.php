        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Form Data Pendidikan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <form role="form">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                     ...
                     <div class="form-group">
                        <label>Upload fotocopy ijazah legalisir <span class="text-danger">*</span></label>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Upload Data Pendidikan</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile">
                            <label class="custom-file-label" for="exampleInputFile">Pilih File</label>
                      ...
                      <div class="form-group">
                        <label>Upload surat keterangan dari universitas / perguruan tinggi / sekolah</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile">
                            <label class="custom-file-label" for="exampleInputFile">Pilih File</label>
