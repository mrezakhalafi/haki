      ...
      <div class="card card-warning">
        ...
        <div class="card-body">
          <form role="form">
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <select class="custom-select" id="biodata-negara">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select" id="provinsi-biodata">
                          <option>Pilih Negara Dahulu</option>
                        </select>
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select" id="kabupaten-biodata">
            ...
            <p><span class="text-primary">* Jika tombol submit tidak aktif padahal data lengkap, maka berarti data
                tersebut sudah ada dalam database.</span></p>
...
<script>
  $(document).ready(() => {
    ...
    $('#biodata-negara').change(() => {
      var countryId = $('#biodata-negara').val();
      var csrf = $('meta[name="csrf-token"]').attr('content');
      var url = '{!! route('provinsi-biodata') !!}';
      ...
      $.ajax({
            ...
            error:function(error){
              alert('Oops ada kesalahan');
            }
        });
    });

    $('#provinsi-biodata').change(() => {
      var provinsiId = $('#provinsi-biodata').val();
      var csrf = $('meta[name="csrf-token"]').attr('content');
      var url = '{!! route('kabupaten-biodata') !!}';
    ...
    function getProvinsi(){
      ...
      $.each(provinsis, (index, item) => {
        options += `<option value="${item.id}">${item.nama}</option>`
      });

      $('#provinsi-biodata').html(options);
    }

    function getKabupaten(){
      var options ='<option value="">Pilih Kabupaten</option>';

      $.each(kabupatens, (index, item) => {
        options += `<option value="${item.id}">${item.nama}</option>`
      });

      $('#kabupaten-biodata').html(options);
    }
